...
The Neuropacs Agent now supports your custom SSO/SAML sign-on protocols with RBAC support. RBAC permissions are based on groupings within our SSO IdP. Contact Neuropacs support (support@neuropacs.com) for assistance configuring SSO on your system.
