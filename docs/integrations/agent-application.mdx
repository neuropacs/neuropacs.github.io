...
[Download the Neuropacs Agent Usage Guide](https://d13kmmwctlljvu.cloudfront.net/agent/docs/neuropacs_agent_usage_guide_v1.0.8.pdf)
...
<IntegrationReleases integration="agent-application" />
